package com.maquinaria_agricola.gestion.service.usuario;

import com.maquinaria_agricola.gestion.encoder.PasswordEncoder;
...
public class UsuarioService {
    ...
    public Usuario getByUserName(String userName) {
        log.info("Obteniendo el usuario con username: {}", userName);
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        if (u.getRole() != null && u.getRole().getRol() != null) {
            authorities.add(new SimpleGrantedAuthority(u.getRole().getRol().getNombre().toUpperCase()));
        }
